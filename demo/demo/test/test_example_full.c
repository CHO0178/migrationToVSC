...
int main(void)
{
	...
	//refman page: 552
	TPM2->SC = TPM_SC_CMOD(1u) | TPM_SC_PS(3u);
	...
	//refman page: 552
	TPM0->SC = TPM_SC_CMOD(1u) | TPM_SC_PS(3u);
	...
	//refman page: 465
	ADC0->CFG1 = ADC_CFG1_ADIV(2u) | ADC_CFG1_MODE(3u);
	...
	//refman page: 578
	PIT->CHANNEL[1u].LDVAL = POT_MEAS_PERIOD - 1u;
